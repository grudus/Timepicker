...
var ClockFace = function () {
    ...
    createClass(ClockFace, [{
        ...
        value: function initViews() {
            ...
            this.clockElem.onclick = function () {
                return _this.selectTime(event, true, _this.clockElem);
            };

            this.innerClockElem.onmousemove = function () {
                return _this.selectTime(event, false, _this.innerClockElem);
            };
            this.innerClockElem.onclick = function () {
                return _this.selectTime(event, true, _this.innerClockElem);
            };
        }
    }, {
        key: "initTimeFaces",
...
//# sourceMappingURL=grudus-timepicker.umd.js.map
